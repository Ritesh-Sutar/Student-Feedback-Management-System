    ...
    <div class="container">
      ...
      <form action="php/feedback.php" method="post" class="student-form">
        ...
        <div class="student-details">
          ...
          <input type="text" name="name1" id="name1" placeholder="Enter Name" required><br>
          <h4 class="head">
            Enter Your Seat no:
          </h4>
          <input type="number" name="rNo" id="rNo" placeholder="Seat Number" required><br>
          <h4 class="head">
            Enter Your PRN no:
          </h4>
          <input type="text" name="prnNo" id="prnNo" placeholder="PRN number" required><br><br>
